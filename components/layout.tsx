          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center gap-3 group">
              <img 
                src="logo.png" 
                alt="Super AIP" 
                className="h-10 md:h-12 w-auto object-contain bg-white rounded-lg p-1.5 border border-transparent group-hover:border-accent/50 transition-colors"
              />
            </Link>
          </div>
        ...
        <div className="col-span-2 lg:col-span-2 pr-8">
          <Link to="/" className="flex items-center gap-2 mb-6">
             <img 
               src="logo.png" 
               alt="Super AIP" 
               className="h-10 md:h-12 w-auto object-contain bg-white rounded-lg p-1.5"
             />
          </Link>
