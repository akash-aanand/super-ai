...
import { Section, SectionHeader, Card, Badge, Button, Hero, MotionPage, FadeIn, Stagger, CheckList, SpotlightCard } from '../components/ui';
...
export const Research = () => (
   <MotionPage>
      ...
      <Section className="relative z-10 pt-0 mt-8 md:mt-12 lg:-mt-24">
         ...
         <FadeIn>
            <Card className="bg-[#050505] border-white/10 p-4 md:p-8 overflow-hidden">
      ...
      <Section className="bg-neutral-900/30 border-y border-white/5">
         ...
         <div className="grid lg:grid-cols-2 gap-16">
            ...
            <FadeIn delay={0.2}>
               <Card className="bg-neutral-950 border-white/10 p-8 h-full">
      ...
      <Section>
         ...
         <div className="grid lg:grid-cols-3 gap-8">
             ...
             <div className="lg:col-span-2 space-y-8">
                <Card className="p-8 md:p-10 bg-gradient-to-br from-neutral-900 to-black border-accent/20">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                   <Card className="p-6">
                      <h4 className="font-bold text-white mb-3 flex items-center gap-2"><Brain size={18} className="text-accent"/> Contextual Extraction</h4>
                      <p className="text-sm text-muted leading-relaxed">
                   ...
                   <Card className="p-6">
                      <h4 className="font-bold text-white mb-3 flex items-center gap-2"><Zap size={18} className="text-accent"/> Boosted Automation</h4>
                      <p className="text-sm text-muted leading-relaxed">
             ...
             {/* Sidebar: Use Cases */}
             <div>
                <Card className="h-full p-8 bg-neutral-950/50">
                   <h3 className="text-lg font-bold text-white mb-6 uppercase tracking-widest border-b border-white/10 pb-4">Trusted Across Sectors</h3>
   ...
   <Section className="relative z-10 pt-0 mt-8 md:mt-12 lg:-mt-24">
      ...
      <Stagger className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
         {[
            ...
            <Card key={idx} className="p-6 bg-neutral-900/50 hover:bg-neutral-900 border-l-2 border-l-accent border-y-0 border-r-0 rounded-r-lg rounded-l-none">
               <div className="mb-4 text-accent"><item.icon size={28} /></div>
          ...
          {[
            ...
            { step: "03", title: "Begin Enablement", desc: "Get immediate access to training, certifications, and partner resources." }
             ...
             <FadeIn key={idx} delay={idx * 0.2} className="relative z-10 flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-full bg-black border-4 border-neutral-800 flex items-center justify-center text-2xl font-bold text-accent mb-6 shadow-xl relative group">
   ...
   <Section>
      ...
      <Stagger className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
             ...
             <div key={idx} className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-transparent hover:from-accent/50 transition-colors duration-500">
         ...
         <FadeIn delay={0.2}>
            ...
            <div className="space-y-6">
               {[
                  ...
                  <Card key={idx} className="p-6 bg-neutral-950 border-l-4 border-l-accent rounded-r-lg rounded-l-none">
                     <h3 className="text-lg font-bold text-white mb-2">{item.title}</h3>
